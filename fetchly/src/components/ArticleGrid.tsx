        ...
        <section className='container mx-auto px-4 lg:px-0'>
            ...
            <div className='mb-8 flex flex-wrap gap-2'>
                {tags.map((tag) => (
                    <button
                        key={tag}
                        className={` ${tag == activeTag && 'bg-slate-dark'} ${tag != activeTag && 'hover:bg-slate-500 hover:cursor-pointer'} px-4 py-2 text-sm font-bold uppercase rounded-2xl bg-slate-700 text-white transition`}
